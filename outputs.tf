output "function_app_identities" {
  ...
  value = {
    for key, value in azurerm_function_app_flex_consumption.function_app : key =>
...
output "function_app_names" {
  ...
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.name }
}
...
output "function_apps_custom_domain_verification_id" {
  ...
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.custom_domain_verification_id }
}

output "function_apps_default_hostnames" {
  description = "The default hostnames of the Linux Function Apps."
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.default_hostname }
}

output "function_apps_outbound_ip_addresses" {
  description = "The outbound IP addresses of the Linux Function Apps."
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.outbound_ip_addresses }
}
...
output "function_apps_possible_outbound_ip_addresses" {
  ...
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.possible_outbound_ip_addresses }
}

output "function_apps_site_credentials" {
  description = "The site credentials for the Linux Function Apps."
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.site_credential }
}

output "linux_function_apps_ids" {
  description = "The IDs of the Linux Function Apps."
  value       = { for app in azurerm_function_app_flex_consumption.function_app : app.name => app.id }
}
