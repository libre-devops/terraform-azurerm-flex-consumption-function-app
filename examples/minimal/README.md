...
# dedicated FC1 plan, keyless storage with a deployment container, a user-assigned identity
# granted the documented role set, and the identity host storage settings wired.
# Applied then destroyed in one CI run.
locals {
  location  = lookup(var.regions, var.loc, "uksouth")
  rg_name   = "rg-${var.short}-${var.loc}-${terraform.workspace}-001"
  func_name = "func-app-${var.short}-${var.loc}-${terraform.workspace}-001"
}
...
| <a name="output_function_app_ids"></a> [function\_app\_ids](#output\_function\_app\_ids) | Map of app name to id. |
<!-- END_TF_DOCS -->
